...
var hackerContent = [
  { title:'Stella', founders: 'Open Source Project by Felix Su built for Launchpad', logo: '/projects/stella-logo.png', desc: 'An AI bot that supports hands-free web browsing.', date: 'Jan 2017', time: '2 min read', url: 'https://github.com/callaunchpad/Stella', urlTitle: 'Source Code', linkIcon: 'github',
    ...
    "<div style='text-align: center'><iframe width='560' height='315' src='https://www.youtube.com/embed/9LalYUO_Wjo' frameborder='0' allowfullscreen></iframe></div>" +
    "<p>At Launchpad we believe that <strong>accessibility</strong> should be a priority for web browsers and search engines. With Stella, users simply use their voices to trigger common actions like scrolling, clicking, answering questions, and playing music. Our next steps include integrating more <strong>Natural Language Processing</strong> capabilities such as <strong>grammar interpretation</strong> and <strong>sentiment analysis</strong> to help our AI scale more easily.</p>" +
    "<p>After we complete the standalone API of Stella using natural language processing and speech recognition, our plan is to improve Stella's test accuracy by training our own <strong>Recurrent Neural Networks (RNN)</strong> and <strong>Long Short Term Memory (LSTM)</strong> networks using recorded samples and data scraped from the web. Our current hypothesis is that, because we have a set of supported commands, overfitting to certain phrases in our training sample may actually improve Stella's performance on test data. However, our goal is to tune hyperparameters until we generalize our model enough to help Stella respond to snippets that have not been included in the training sets.</p>" +
    "<p>Using a combination of <strong>machine learning</strong> and <strong>artificial intelligence</strong>, we hope to spend the next semester or two developing this concept of internet browsing that puts accessibility first.</p>"
  },
